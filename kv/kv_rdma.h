...
void kv_rdma_free(kv_rdma_handle);
...
int kv_rdma_listen(kv_rdma_handle self, char *addr_str, char *port_str, kv_rdma_connect_cb cb, void *cb_arg);
...
int kv_rdma_disconnect(connection_handle h);
#endif