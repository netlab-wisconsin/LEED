...
typedef void (*kv_rdma_req_cb)(connection_handle h, bool success, kv_rdma_mr req, kv_rdma_mr resp, void *cb_arg);
typedef void (*kv_rdma_connect_cb)(connection_handle h, void *cb_arg);
typedef void (*kv_rdma_disconnect_cb)(void *cb_arg);
typedef void (*kv_rdma_req_handler)(void *req_h, kv_rdma_mr req, uint32_t req_sz, void *arg);
