...
MOODYCAMEL_EXPORT int moodycamel_cq_enqueue_with_token(MoodycamelCQHandle handle, MoodycamelToken prod_token,
                                                       MoodycamelValue value);
MOODYCAMEL_EXPORT size_t moodycamel_cq_enqueue_bulk_with_token(MoodycamelCQHandle handle, MoodycamelToken prod_token,
...
MOODYCAMEL_EXPORT int moodycamel_cq_try_dequeue_with_token(MoodycamelCQHandle handle, MoodycamelToken cons_token,
                                                           MoodycamelValue* value);
MOODYCAMEL_EXPORT size_t moodycamel_cq_try_dequeue_bulk(MoodycamelCQHandle handle, MoodycamelValue* values, size_t max);
MOODYCAMEL_EXPORT size_t moodycamel_cq_try_dequeue_bulk_with_token(MoodycamelCQHandle handle, MoodycamelToken cons_token,
                                                                   MoodycamelValue* values, size_t max);
MOODYCAMEL_EXPORT size_t moodycamel_cq_size_approx(MoodycamelCQHandle handle);

MOODYCAMEL_EXPORT int moodycamel_cons_token(MoodycamelCQHandle handle, MoodycamelToken* token);
MOODYCAMEL_EXPORT int moodycamel_prod_token(MoodycamelCQHandle handle, MoodycamelToken* token);
