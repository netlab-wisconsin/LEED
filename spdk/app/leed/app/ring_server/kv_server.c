...
static void help(void) {
    ...
    printf("  -n <num_items>   Set the maximum number of items: %lu\n", opt.num_items);
    printf("  -v <value_size>  Set the maximum value size: %u\n", opt.value_size);
    ...
    printf("  -M <ring_num>    Set the number of hash ring (must be same within a cluster): %u\n", opt.ring_num);
